 ...
 * -Similar al metodo filter, se debe cumplir una condicion 
 * para que el elemento que cumpla con esa condicion, sea 
 * retornado
 * -solo es retornado el primer elemento que cumpla
 * con la condicion.
 * -Si ningun elemento cumple con la condicion, se retorna
 * un UNDEFINED
 * 
 */
 let users = [
